...
// File Name: LogValuesFormatter.cs
// Author:  Kyle Crowder
...
internal sealed class LogValuesFormatter
{
    ...
    {
        return !TryFormatArgumentIfNullOrEnumerable(arg0, out object? arg0String)
    ...
    {
        return TryFormatArgumentIfNullOrEnumerable(arg0, out object? arg0String) | TryFormatArgumentIfNullOrEnumerable(arg1, out object? arg1String)
    ...
    private static bool TryFormatArgumentIfNullOrEnumerable<T>(T? value, [NotNullWhen(true)] out object? stringValue)
    {
        ...
        if (value is not string && value is IEnumerable enumerable)
        {
            ...
            foreach (object? e in enumerable)
            {
                ...
                vsb.Append(e is IFormattable f ? f.ToString(null, CultureInfo.InvariantCulture) : e is not null ? e.ToString() : NullValue);
                first = false;
            }
